...
@Component({
  selector: 'app-respuestas-ganaderia-l6',
  templateUrl: './respuestas-ganaderia-l6.component.html',
  styleUrls: ['./respuestas-ganaderia-l6.component.scss']
})
export class RespuestasGanaderiaL6Component implements OnInit {
