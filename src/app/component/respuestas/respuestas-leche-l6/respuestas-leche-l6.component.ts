...
@Component({
  selector: 'app-respuestas-leche-l6',
  templateUrl: './respuestas-leche-l6.component.html',
  styleUrls: ['./respuestas-leche-l6.component.scss']
})
export class RespuestasLecheL6Component implements OnInit {
