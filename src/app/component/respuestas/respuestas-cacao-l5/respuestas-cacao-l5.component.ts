...
@Component({
  selector: 'app-respuestas-cacao-l5',
  templateUrl: './respuestas-cacao-l5.component.html',
  styleUrls: ['./respuestas-cacao-l5.component.scss']
})
export class RespuestasCacaoL5Component implements OnInit {
