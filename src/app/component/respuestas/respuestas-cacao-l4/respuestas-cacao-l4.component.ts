...
@Component({
  selector: 'app-respuestas-cacao-l4',
  templateUrl: './respuestas-cacao-l4.component.html',
  styleUrls: ['./respuestas-cacao-l4.component.scss']
})
export class RespuestasCacaoL4Component implements OnInit {
