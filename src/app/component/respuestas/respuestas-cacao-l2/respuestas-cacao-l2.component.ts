...
@Component({
  selector: 'app-respuestas-cacao-l2',
  templateUrl: './respuestas-cacao-l2.component.html',
  styleUrls: ['./respuestas-cacao-l2.component.scss']
})
export class RespuestasCacaoL2Component implements OnInit {
