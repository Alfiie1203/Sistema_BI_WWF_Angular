...
@Component({
  selector: 'app-respuestas-ganaderia-l4',
  templateUrl: './respuestas-ganaderia-l4.component.html',
  styleUrls: ['./respuestas-ganaderia-l4.component.scss']
})
export class RespuestasGanaderiaL4Component implements OnInit {
