...
@Component({
  selector: 'app-respuestas-palm-l4',
  templateUrl: './respuestas-palm-l4.component.html',
  styleUrls: ['./respuestas-palm-l4.component.scss']
})
export class RespuestasPalmL4Component implements OnInit {
