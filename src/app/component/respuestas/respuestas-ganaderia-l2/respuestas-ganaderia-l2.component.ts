...
@Component({
  selector: 'app-respuestas-ganaderia-l2',
  templateUrl: './respuestas-ganaderia-l2.component.html',
  styleUrls: ['./respuestas-ganaderia-l2.component.scss']
})
export class RespuestasGanaderiaL2Component implements OnInit {
