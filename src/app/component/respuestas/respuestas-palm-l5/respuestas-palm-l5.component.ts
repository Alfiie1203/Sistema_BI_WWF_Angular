...
@Component({
  selector: 'app-respuestas-palm-l5',
  templateUrl: './respuestas-palm-l5.component.html',
  styleUrls: ['./respuestas-palm-l5.component.scss']
})
export class RespuestasPalmL5Component implements OnInit {
