...
@Component({
  selector: 'app-respuestas-leche-l1',
  templateUrl: './respuestas-leche-l1.component.html',
  styleUrls: ['./respuestas-leche-l1.component.scss']
})
export class RespuestasLecheL1Component implements OnInit {
