...
@Component({
  selector: 'app-respuestas-leche-l4',
  templateUrl: './respuestas-leche-l4.component.html',
  styleUrls: ['./respuestas-leche-l4.component.scss']
})
export class RespuestasLecheL4Component implements OnInit {
