...
@Component({
  selector: 'app-respuestas-ganaderia-l3',
  templateUrl: './respuestas-ganaderia-l3.component.html',
  styleUrls: ['./respuestas-ganaderia-l3.component.scss']
})
export class RespuestasGanaderiaL3Component implements OnInit {
