...
@Component({
  selector: 'app-respuestas-palm-l3',
  templateUrl: './respuestas-palm-l3.component.html',
  styleUrls: ['./respuestas-palm-l3.component.scss']
})
export class RespuestasPalmL3Component implements OnInit {
