...
@Component({
  selector: 'app-respuestas-leche-l5',
  templateUrl: './respuestas-leche-l5.component.html',
  styleUrls: ['./respuestas-leche-l5.component.scss']
})
export class RespuestasLecheL5Component implements OnInit {
