...
@Component({
  selector: 'app-respuestas-cacao-l6',
  templateUrl: './respuestas-cacao-l6.component.html',
  styleUrls: ['./respuestas-cacao-l6.component.scss']
})
export class RespuestasCacaoL6Component implements OnInit {
