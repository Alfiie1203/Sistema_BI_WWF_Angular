...
@Component({
  selector: 'app-respuestas-ganaderia-l5',
  templateUrl: './respuestas-ganaderia-l5.component.html',
  styleUrls: ['./respuestas-ganaderia-l5.component.scss']
})
export class RespuestasGanaderiaL5Component implements OnInit {
