...
@Component({
  selector: 'app-respuestas-cacao-l1',
  templateUrl: './respuestas-cacao-l1.component.html',
  styleUrls: ['./respuestas-cacao-l1.component.scss']
})
export class RespuestasCacaoL1Component implements OnInit {
