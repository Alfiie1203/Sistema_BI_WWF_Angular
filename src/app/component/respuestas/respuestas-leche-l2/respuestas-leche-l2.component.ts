...
@Component({
  selector: 'app-respuestas-leche-l2',
  templateUrl: './respuestas-leche-l2.component.html',
  styleUrls: ['./respuestas-leche-l2.component.scss']
})
export class RespuestasLecheL2Component implements OnInit {
