...
@Component({
  selector: 'app-respuestas-palm-l6',
  templateUrl: './respuestas-palm-l6.component.html',
  styleUrls: ['./respuestas-palm-l6.component.scss']
})
export class RespuestasPalmL6Component implements OnInit {
