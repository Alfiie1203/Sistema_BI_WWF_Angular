...
@Component({
  selector: 'app-respuestas-palm-l2',
  templateUrl: './respuestas-palm-l2.component.html',
  styleUrls: ['./respuestas-palm-l2.component.scss']
})
export class RespuestasPalmL2Component implements OnInit {
