...
@Component({
  selector: 'app-respuestas-leche-l3',
  templateUrl: './respuestas-leche-l3.component.html',
  styleUrls: ['./respuestas-leche-l3.component.scss']
})
export class RespuestasLecheL3Component implements OnInit {
