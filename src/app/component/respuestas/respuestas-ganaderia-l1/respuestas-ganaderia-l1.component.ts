...
@Component({
  selector: 'app-respuestas-ganaderia-l1',
  templateUrl: './respuestas-ganaderia-l1.component.html',
  styleUrls: ['./respuestas-ganaderia-l1.component.scss']
})
export class RespuestasGanaderiaL1Component implements OnInit {
